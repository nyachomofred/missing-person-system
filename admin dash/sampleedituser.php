...
<div class="container">
    ...
    <tbody>
    <?php 
        $sqlgetuser="SELECT `Username`,`First_Name`,`Last_Name`,`Email`,`Phone_No` FROM user ORDER BY `First_Name` ";
