...
<!--start of stylish search box body-->
      <div class="container">
  <div class="row">
  <form method="POST" action="../app/process-searchsearcher.php">
  <div class="container">
  <h2 style="color: green;"><b>Active Searchers</b></h2>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
        <h4><?php 
        $sqltotaluser="SELECT COUNT(*) AS totalsearchers FROM searcher WHERE `Status`='1' ";
        $sqlrun=mysqli_query($conn,$sqltotaluser);
        while ($rowcount=mysqli_fetch_assoc($sqlrun)) {
            $totalsearcher=$rowcount['totalsearchers'];
        }
        ?>
        <p><a href="viewblockedsearcher.php" style="text-decoration: none;">View Blocked Searchers</a></p>
        <p>Total Active Searchers: <b style="color: green;"><?php echo$totalsearcher;?></b></p>
    ...
    <tbody>
    <?php 
        $sqlgetuser="SELECT `Username`,`First_Name`,`Last_Name`,`Email`,`Phone_No` FROM searcher WHERE `Status`='1' ORDER BY `First_Name` ";
