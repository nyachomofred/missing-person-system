...
if(isset($_POST['submit'])){
	...
	if($sql_num!=1){
		header("refresh:3;url=../views/reportmissingperson.php");
   ...
   $sql="INSERT INTO `missingpersons`.`missing` (`ID`, `Full_Name`, `Im	age`, `Age`, `Height`, `Weight`, `Gender`, `SkinColor`, `HairColor`, `EyeColor`, `Date_Missing`, `Description`, `Date_Reported`,`Reporter_ID`) VALUES (NULL, '".$fullname."', '".$image."', '".$age."', '".$height."', '".$weight."', '".$gender."', '".$skincolor."', '".$haircolor."', '".$eyecolor."', '".$datemissing."', '".$desc."', CURRENT_TIMESTAMP,'".$national_id."')";
   ...
   window.location="../views/admin_dashboard.php"
    </script>
    <?php
		}else{
