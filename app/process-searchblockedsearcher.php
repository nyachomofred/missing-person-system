...
if (isset($_POST['btnsubmitsearch'])) {
	...
	$sqlgetuser="SELECT `Username`,`First_Name`,`Last_Name`,`Email`,`Phone_No` FROM searcher WHERE `Status`='0' AND `Username`='".$username."' ORDER BY `First_Name` ";
