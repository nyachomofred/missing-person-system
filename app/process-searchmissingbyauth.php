...
<!--start of header bar -->
	...
	<div class="row">
		<div class="page-header">
          <a href="../views/authorised/authoriseddashboard.php" style="text-decoration: none;color: rgb(51,51,51);"><h1>Kenyan Missing</h1></a>
          <span class="icon-bar">
...
if (isset($_POST['btnsubmitsearch'])) {
	...
	$sql="SELECT `ID`,`Full_Name`,`Image`,`Age`,`Height`,`Weight`,`Gender`,`SkinColor`,`HairColor`,`EyeColor`,`Date_Missing`,`Description`,`Date_Reported`,`Reporter_ID` FROM missing WHERE `Full_Name` LIKE  '%".$fullname."%'";
	$query_run=mysqli_query($conn,$sql);
	$num_rows=mysqli_num_rows($query_run);
	if($num_rows==0){
		header("refresh:3;url=../views/authorised/displaymissingpersons.php");
...
<!--start of html to display the missing person with a default image with name,age,last seen and county-->
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="container">
      <a href="../views/authorised/missingpersondetail.php?id=<?php echo $id?>"><img src="../storage/img/default.jpg" alt="..." class="img-responsive" data-toggle="tooltip" data-placement="bottom" title="View full profile"></a>
      </div>
      <div class="container">
        <h3><?php echo $name;?></h3>
        <p><strong style="color: green;">AGE:</strong> <?php echo $age;?></p>
        <p><strong style="color: green;">LAST SEEN: </strong><?php echo $lastseen;?></p>
...
<!--start of html to display the missing person with an image image with name,age,last seen and county-->
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
    <div class="container">
      <a href="../views/authorised/missingpersondetail.php?id=<?php echo $id?>"><img src="../storage/img/<?php echo $img;?>" alt="..." class="img-responsive" data-toggle="tooltip" data-placement="bottom" title="View full profile"></a>
      </div>
      <div class="container">
        <h3><?php echo $name;?></h3>
        <p><strong style="color: green;">AGE:</strong> <?php echo $age;?></p>
