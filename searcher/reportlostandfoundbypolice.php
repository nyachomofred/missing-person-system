...
<div class="container">
    ...
    <div class="col-md-4">
        <div class="form_main">
                ...
                <div class="form">
               <form action="../../app/process-reportlostandfoundbysearcher.php" method="post" id="contactFrm" name="contactFrm" enctype="multipart/form-data">
               <fieldset><legend>Lost and Found Detail</legend>
                    ...
                    <input type="text" required="" placeholder="Date Found?(mm/dd/yyyy)" id="datepicker" value="" name="datepicker" class="txt">
