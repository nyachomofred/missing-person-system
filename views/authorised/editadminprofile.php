...
<div class="well">
    ...
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
        <form class="form-horizontal" action="../../app/process-editauth.php" method="post">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-8">
   ...
   <input type="submit" name="btnupdate"  id="btnupdate" class="btn btn-success" value="Update Profile">
    <input type="button" class="btn btn-danger" value="Cancel" onClick="window.location='authoriseddashboard.php';">
  </div>
</div>
      ...
      <form id="tab2" action="../../app/process-changeauthpassword.php" method="post">
