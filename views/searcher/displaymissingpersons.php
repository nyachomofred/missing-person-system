...
<!--start of stylish search box body-->
      <div class="container">
  <div class="row">
  <form method="POST" action="../../app/process-searchmissingbysearcher.php">
  <div class="container">
  <h2 style="color: red;"><b>Missing Persons</b></h2>
...
<hr>
	...
	<?php 
		$sql="SELECT * FROM missing ORDER BY Date_Reported DESC";
...
<!--start of html to display the missing person with a default image with name,age,last seen and county-->
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="container">
      ...
      <a href="missingpersondetail.php?id=<?php echo $id?>"><img src="../../../storage/img/default.jpg" alt="..." class="img-responsive" data-toggle="tooltip" data-placement="bottom" title="View full profile"></a>
      </div>
      <div class="container">
...
<!--start of html to display the missing person with an image image with name,age,last seen and county-->
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="container">
      ...
      <a href="missingpersondetail.php?id=<?php echo $id?>"><img src="../../storage/img/<?php echo $img;?>" alt="..." class="img-responsive" data-toggle="tooltip" data-placement="bottom" title="View full profile"></a>
      </div>
      <div class="container">
        <h3><?php echo $name;?></h3>
        <p><strong style="color: green;">AGE:</strong> <?php echo $age;?></p>
