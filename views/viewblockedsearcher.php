...
<!--start of stylish search box body-->
      <div class="container">
  <div class="row">
  <form method="POST" action="../app/process-searchblockedsearcher.php">
  <div class="container">
  <h2 style="color: red;"><b>Blocked Searchers</b></h2>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
        <h4><?php 
        $sqltotaluser="SELECT COUNT(*) AS Deactivated_Searcher FROM searcher WHERE `Status`='0' ";
        $sqlrun=mysqli_query($conn,$sqltotaluser);
        while ($rowcount=mysqli_fetch_assoc($sqlrun)) {
            $totaldsearcher=$rowcount['Deactivated_Searcher'];
        }
        ?>
        <a href="viewsearcher.php" style="text-decoration: none;">View Active Searchers</a>
        <p>Total Blocked Searchers: <b style="color: red;"><?php echo $totaldsearcher;?></b></p>
    ...
    <tbody>
    <?php 
        $sqlgetuser="SELECT `Username`,`First_Name`,`Last_Name`,`Email`,`Phone_No` FROM searcher WHERE `Status`='0' ORDER BY `First_Name` ";
