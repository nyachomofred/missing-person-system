...
<!--start of stylish search box body-->
      <div class="container">
  <div class="row">
  <form method="POST" action="../app/process-searchuser.php">
  <div class="container">
  <h2 style="color: green;"><b>Active Users</b></h2>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
        <h4><?php 
        $sqltotaluser="SELECT COUNT(*) AS totalusers FROM user WHERE `Status`='1' ";
        $sqlrun=mysqli_query($conn,$sqltotaluser);
        while ($rowcount=mysqli_fetch_assoc($sqlrun)) {
            $totaluser=$rowcount['totalusers'];
        }
        ?>
        <p><a href="viewblockeduser.php" style="text-decoration: none;">View Blocked Users</a></p>
        <p>Total Active Users: <b style="color: green;"><?php echo$totaluser;?></b></p>
    ...
    <tbody>
    <?php 
        $sqlgetuser="SELECT `Username`,`First_Name`,`Last_Name`,`Email`,`Phone_No` FROM user WHERE `Status`='1' ORDER BY `First_Name` ";
